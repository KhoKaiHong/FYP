...
async fn logout_user(
    ...
    UserSessionModelController::delete_by_refresh_token_and_user_id(
        &context,
        model_manager,
        refresh_token_jti,
    )
...
async fn logout_facility(
    ...
    FacilitySessionModelController::delete_by_refresh_token_and_facility_id(
        &context,
        model_manager,
        refresh_token_jti,
    )
...
async fn logout_organiser(
    ...
    OrganiserSessionModelController::delete_by_refresh_token_and_organiser_id(
        &context,
        model_manager,
        refresh_token_jti,
    )
...
async fn logout_admin(
    ...
    AdminSessionModelController::delete_by_refresh_token_and_admin_id(
        &context,
        model_manager,
        refresh_token_jti,
    )
