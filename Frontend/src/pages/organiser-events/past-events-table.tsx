...
export function PastEventsTable<TData, TValue>(props: DataTableProps<TData, TValue>) {
  ...
  return (
    <div>
      <div class="flex items-center pb-4 gap-2">
        ...
        >
          <TextField placeholder="Filter facility..." />
        </TextFieldRoot>
        <TextFieldRoot
          class="w-full max-w-xs"
          value={
            ...
            <Show
              ...
              fallback={
                <TableRow>
                  ...
                  >
                    You currently have no past / ongoing events organised.
                  </TableCell>
                </TableRow>
              }
            >
